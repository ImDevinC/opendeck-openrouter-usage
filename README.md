...
An [OpenAction](https://openaction.amankhanna.me) plugin for [OpenDeck](https://github.com/nekename/OpenDeck) that shows your remaining [OpenRouter](https://openrouter.ai) credits. The plugin is listed as **OpenRouter Credits** in OpenDeck; its single action is **Credits**, under the `OpenRouter` category.
